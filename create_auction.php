  ...
  <div class="card">
    <div class="card-body">
      ...
      <form method="post" action="create_auction_result.php">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
	        <div class="input-group">
              ...
              <input type="number" class="form-control" id="auctionStartPrice" name="openingPrice" step="0.01">
            </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <div class="input-group">
              ...
              <input type="number" class="form-control" id="auctionReservePrice" name="reservePrice" step="0.01" value="0.00">
            </div>
        ...
        <button type="submit" class="btn btn-primary form-control" name="createAuctionSubmit">Create Auction</button>
